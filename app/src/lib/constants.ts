...
export const MATERIAL_TYPES = [
  { key: 'API' as const, label: 'مادة فعالة (API)', icon: Beaker },
  { key: 'Excipient' as const, label: 'مادة مضافة', icon: Package },
  { key: 'Packaging' as const, label: 'تعبئة وتغليف', icon: Package },
  { key: 'Solvent' as const, label: 'مذيب', icon: Beaker },
] as const;
